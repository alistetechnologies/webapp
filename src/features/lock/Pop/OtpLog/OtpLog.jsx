...
function OtpLog({ lock, open, setOpen }) {
  ...
  return (
    ...
    >
      ...
      >
        <DialogHeader>
          <DialogTitle className=" flex justify-between"><div>OTP History</div><div className="shadow-2xs justify-center items-start flex cursor-pointer border-2 leading-none rounded-[50%] w-6 h-6" onClick={()=>{
            setRecord([])
             setOpen(false)
          }}>x</div></DialogTitle>
